    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .anyRequest().authenticated() // Always a good ides to put this last
                )
                .headers(headers -> headers.frameOptions(Customizer.withDefaults()).disable())// Makes h2-console public
